...
original_class = 3  # Class to apply the trigger to
num_epochs = 25
...
for percentage_to_change in range(0, 101, 10):
    ...
    model.classifier = nn.Sequential(
        nn.Linear(512, 10)  # Change output layer to match CIFAR-10 classes
    )
    ...
    torch.save(training_stats, f"/sub_folder/cifar10_trigger_vgg16_{percentage_to_change}.pth")